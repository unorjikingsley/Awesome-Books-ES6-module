...
This project was built using the ES6 module. The website is used to an books and remove books from a library website. The essence of this project is to sharpen my skills with ES6. 
...
- Books are stored with name and title
- contact page and a page for book stored
- Error free
- local storage
